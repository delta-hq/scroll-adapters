export default [
  ...
  },
  {
    ...
    inputs: [
      { name: "reduceAmount", type: "uint256", internalType: "uint256" },
    ],
    outputs: [{ name: "", type: "uint256", internalType: "uint256" }],
    stateMutability: "nonpayable",
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "repayAmount", type: "uint256", internalType: "uint256" },
      {
        ...
        type: "address",
        internalType: "contract RTokenInterface",
      },
    ],
    outputs: [{ name: "", type: "uint256", internalType: "uint256" }],
    stateMutability: "nonpayable",
  ...
  {
    type: "event",
    name: "NewRedemptionReserveFactor",
    inputs: [
      {
        name: "oldRedemptionReserveFactor",
        type: "uint256",
        indexed: false,
        internalType: "uint256",
      },
